...
public class SubInstructions {

	public static class ISUB extends NoOperandInstruction {
	...
	public static class LSUB extends NoOperandInstruction {
	...
	public static class FSUB extends NoOperandInstruction {
	...
	public static class DSUB extends NoOperandInstruction {
